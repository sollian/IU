...
package external.GifImageViewEx.com.foxykeep.datadroid.internal.network;
...
import external.GifImageViewEx.com.foxykeep.datadroid.network.UserAgentUtils;
import external.GifImageViewEx.com.foxykeep.datadroid.network.NetworkConnection.ConnectionResult;
import external.GifImageViewEx.com.foxykeep.datadroid.network.NetworkConnection.Method;
...
public final class NetworkConnectionImpl {
    ...
    private static final String TAG = NetworkConnectionImpl.class
            .getSimpleName();
    ...
    private static final int OPERATION_TIMEOUT = 10 * 1000;
     ...
     * 
     * @param context The context to use for this operation. Used to generate
     *            the user agent if needed.
     ...
     * @param isGzipEnabled Whether the request will use gzip compression if
     *            available on the server.
     * @param userAgent The user agent to set in the request. If null, a default
     *            Android one will be created.
     * @param postText The POSTDATA text to add in the request.
     * @param credentials The credentials to use for authentication.
     * @param isSslValidationEnabled Whether the request will validate the SSL
     *            certificates.
        ...
        try {
            ...
            if (DataDroidLog.canLog(Log.DEBUG)) {
                ...
                if (parameterList != null && !parameterList.isEmpty()) {
                    ...
                    DataDroidLog.d(TAG,
                            "Parameters String: \"" + paramBuilder.toString()
                                    + "\"");
                }
                ...
                if (headerMap != null && !headerMap.isEmpty()) {
                    ...
                    for (Entry<String, String> header : headerMap.entrySet()) {
                        DataDroidLog.d(TAG, "- " + header.getKey() + " = "
                                + header.getValue());
                    }
                }
            }

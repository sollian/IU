...
package external.GifImageViewEx.com.foxykeep.datadroid.requestmanager;
...
import external.GifImageViewEx.com.foxykeep.datadroid.util.ObjectUtils;

/**
 * Class used to store your request information : request type as well as
 * parameters.
 * 
 * @author Foxykeep
 */
public final class Request implements Parcelable {
    ...
    /**
     * Set whether the data returned from the {@link RequestService} must be
     * cached in memory or not.
     * 
     * @param enabled Whether the data returned from the {@link RequestService}
     *            must be cached in memory or not.
     */
    ...
    /**
     * Return whether the data returned from the {@link RequestService} must be
     * cached in memory or not.
     * 
     * @return Whether the data returned from the {@link RequestService} must be
     *         cached in memory or not.
    ...
    /**
     * Add a boolean parameter to the request, replacing any existing value for
     * the given name.
     * 
    ...
    /**
     * Add a byte parameter to the request, replacing any existing value for the
     * given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a char parameter to the request, replacing any existing value for the
     * given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a short parameter to the request, replacing any existing value for
     * the given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a int parameter to the request, replacing any existing value for the
     * given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a long parameter to the request, replacing any existing value for the
     * given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a float parameter to the request, replacing any existing value for
     * the given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a double parameter to the request, replacing any existing value for
     * the given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a String parameter to the request, replacing any existing value for
     * the given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a CharSequence parameter to the request, replacing any existing value
     * for the given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Add a Parcelable parameter to the request, replacing any existing value
     * for the given name.
     * 
     * @param name The parameter name.
     * @param value The parameter value.
    ...
    /**
     * Returns the value associated with the given name, or false if no mapping
     ...
     * Parcelable objects.
     * 
     * @param classLoader The ClassLoader to use by the underlying Bundle when
     *            getting Parcelable objects.
     */
        ...
        if (o instanceof Request) {
            ...
            for (int i = 0, length = mParamList.size(); i < length; i++) {
                ...
                switch (mTypeList.get(i)) {
                    case TYPE_BOOLEAN:
                        if (mBundle.getBoolean(param) != oParams.mBundle
                                .getBoolean(param)) {
                            return false;
                        }
                        break;
                    case TYPE_BYTE:
                        if (mBundle.getByte(param) != oParams.mBundle
                                .getByte(param)) {
                            return false;
                        }
                        break;
                    case TYPE_CHAR:
                        if (mBundle.getChar(param) != oParams.mBundle
                                .getChar(param)) {
                            return false;
                        }
                        break;
                    case TYPE_SHORT:
                        if (mBundle.getShort(param) != oParams.mBundle
                                .getShort(param)) {
                            return false;
                        }
                        break;
                    case TYPE_INT:
                        ...
                        break;
                    case TYPE_LONG:
                        if (mBundle.getLong(param) != oParams.mBundle
                                .getLong(param)) {
                            return false;
                        }
                        break;
                    case TYPE_FLOAT:
                        if (mBundle.getFloat(param) != oParams.mBundle
                                .getFloat(param)) {
                            return false;
                        }
                        break;
                    case TYPE_DOUBLE:
                        if (mBundle.getDouble(param) != oParams.mBundle
                                .getDouble(param)) {
                            return false;
                        }
                        break;

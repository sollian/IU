...
package external.GifImageViewEx.com.foxykeep.datadroid.network;
...
import external.GifImageViewEx.com.foxykeep.datadroid.internal.network.NetworkConnectionImpl;
...
/**
 * This class gives the user an API to easily call a webservice and return the
 * received response.
 * 
 * @author Foxykeep
 */
public final class NetworkConnection {
    ...
    private static final String LOG_TAG = NetworkConnection.class
            .getSimpleName();
     ...
     * <p>
     * Contains the headers and the body of the response as an unparsed
     * <code>String</code>.
     * 
     * @author Foxykeep
     */
     ...
     * 
     * @param context The context used by the {@link NetworkConnection}. Used to
    ...
    public NetworkConnection(Context context, String url) {
        if (url == null) {
            DataDroidLog
                    .e(LOG_TAG,
                            "NetworkConnection.NetworkConnection - request URL cannot be null.");
     ...
     * <p>
     * If set to another value than {@link Method#POST}, the POSTDATA text will
     * be reset as it can only be used with a POST request.
     * 
    ...
    /**
     * Set the parameters to add to the request. This is meant to be a "key" =>
     * "value" Map.
     * <p>
     ...
     * The POSTDATA text will be reset as they cannot be used at the same time.
     * <p>
     * This method allows you to have multiple values for a single key in
     * contrary to the HashMap version of the method (
     * {@link #setParameters(HashMap)})
     * 
     * @see #setPostText(String)
     ...
     * @return The networkConnection.
     */
    public NetworkConnection setParameters(
    ...
    /**
     * Set whether the request will use gzip compression if available on the
     * server. Default is true.
     * 
     * @param isGzipEnabled Whether the request will user gzip compression if
    ...
    /**
     * Set the user agent to set in the request. Otherwise a default Android one
     * will be used.
     * 
    ...
    /**
     * Set the POSTDATA text that will be added in the request. Also
     * automatically set the {@link Method} to {@link Method#POST} to be able to
     * use it.
     * <p>
    ...
    /**
     * Set the POSTDATA text that will be added in the request and also set the
     * {@link Method} to use. The Method can only be {@link Method#POST} or
     * {@link Method#PUT}.
     * <p>
     * The parameters will be reset as they cannot be used at the same time.
     * 
     ...
     * @return The networkConnection.
     */
    public NetworkConnection setCredentials(
    ...
    public ConnectionResult execute() throws ConnectionException {
        return NetworkConnectionImpl.execute(mContext, mUrl, mMethod,
                mParameterList, mHeaderMap, mIsGzipEnabled, mUserAgent,
                mPostText, mCredentials, mIsSslValidationEnabled);
    }
}

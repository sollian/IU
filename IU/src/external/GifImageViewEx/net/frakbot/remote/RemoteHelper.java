...
package external.GifImageViewEx.net.frakbot.remote;
...
/**
 * Helper class that exposes some utility methods for retrieving objects from
 * the network.
 * 
...
public class RemoteHelper {
    ...
    public static byte[] download(String resourceUrl) throws IOException {
        ...
        if (responseCode != HttpURLConnection.HTTP_OK) {
            Logcat.w(LOG_TAG, "Downloading from URL " + resourceUrl
        ...
        Logcat.d(LOG_TAG, "fetching " + resourceUrl + " ("

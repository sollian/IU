...
package external.GifImageViewEx.net.frakbot.cache;
...
public class CacheHelper {
    ...
    public static File getDiskCacheDir(Context context, String file) {
    ...
    public static String getSubOfRootDir(Context context) {
        ...
        if (android.os.Environment.getExternalStorageState().equals(
            ...
            rootDir = getExternDir(rootDir) + "/ftxcn";
        } else {
            rootDir = context.getCacheDir().getPath() + "/ftxcn";
        }
        return rootDir;
    }

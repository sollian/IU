...
import external.GifImageViewEx.net.frakbot.remote.RemoteHelper;

import java.io.IOException;

/**
 * Operation to download an image from the network. Requested input: -
    ...
    public Bundle execute(Context context, Request request)
        ...
        try {
            ...
            throw new DataException(
                    "NETWORK: Error while getting value for URL " + url);
        }
        ...
        if (image != null) {
            ...
            try {
                Editor editor = diskCache.edit(CacheHelper
                        .UriToDiskLruCacheString(url));
                if (editor != null) {
                ...
                Logcat.w(ImageDownloadOperation.class.getSimpleName(),
                        "Storage of image into the disk cache failed!");
            }

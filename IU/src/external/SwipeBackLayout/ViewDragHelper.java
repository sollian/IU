...
package external.SwipeBackLayout;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link external.SwipeBackLayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link external.SwipeBackLayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link external.SwipeBackLayout.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link external.SwipeBackLayout.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     * 
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system

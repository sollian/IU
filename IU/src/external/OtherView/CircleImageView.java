...
import external.SmartImageView.WebImage;
...
public class CircleImageView extends SmartImageView implements OnCompleteListener {
    ...
    public void setImageURL(String url) {
        setImage(new WebImage(url), R.drawable.iu_default_gray,
                R.drawable.iu_default_green, this);
    }

...
public class AnimateDismissAdapter<T> extends BaseAdapterDecorator {
     ...
     * .
     * 
     * @param callback The {@link OnDismissCallback} to trigger when the user
     *            has indicated that she would like to dismiss one or more list
     *            items.
     */
    public AnimateDismissAdapter(BaseAdapter baseAdapter,

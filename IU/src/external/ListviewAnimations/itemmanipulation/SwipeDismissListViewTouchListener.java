...
package external.ListviewAnimations.itemmanipulation;
 ...
 * clicks, etc. For performance reasons, do not use this class directly, but use
 * the {@link SwipeDismissAdapter}.
 */
...
public class SwipeDismissListViewTouchListener implements SwipeOnTouchListener {
     ...
     */
    public SwipeDismissListViewTouchListener(AbsListView listView,
            OnDismissCallback callback, SwipeOnScrollListener onScroll) {
     ...
     */
    protected PendingDismissData createPendingDismissData(int position,
            View view) {
    ...
    private boolean handleDownEvent(MotionEvent motionEvent) {
        ...
        if (downView != null) {
            ...
            mCurrentDismissData = createPendingDismissData(downPosition,
                    downView);
    ...
    private boolean handleUpEvent(MotionEvent motionEvent) {
        ...
        if (mSwiping) {
            if (dismiss) {
                ...
                animate(mCurrentDismissData.view)
                ...
                // cancel
                animate(mCurrentDismissData.view).translationX(0).alpha(1)
    ...
    protected class PendingDismissData implements
     ...
     */
    protected void recycleDismissedViewsItems(
            List<PendingDismissData> pendingDismisses) {

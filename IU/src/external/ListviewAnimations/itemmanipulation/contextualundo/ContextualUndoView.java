...
public class ContextualUndoView extends FrameLayout {
    ...
    public ContextualUndoView(Context context, int undoLayoutResId,
            int countDownTextViewResId) {
        super(context);
    ...
    private void initUndo(int undoLayoutResId, final int countDownTextViewResId) {
        ...
        if (countDownTextViewResId != -1) {
            mCountDownTV = (TextView) mUndoView
                    .findViewById(countDownTextViewResId);
        }
    }

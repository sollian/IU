...
public class ArcMenu extends RelativeLayout {
    ...
    private Animation createItemDisapperAnimation(final long duration,
        ...
        animationSet.setAnimationListener(new AnimationListener() {
            ...
            @Override
            public void onAnimationEnd(Animation animation) {
                for (View item : listItem) {
                    if (item instanceof FrameLayout) {
                        FrameLayout fl = (FrameLayout) item;
    ...
    private Animation createHintSwitchAnimation(final boolean expanded) {
        ...
        animation.setAnimationListener(new AnimationListener() {
            ...
            @Override
            public void onAnimationEnd(Animation animation) {
                boolean flag = mArcLayout.isExpanded();
                for (View item : listItem) {
                    if (item instanceof FrameLayout) {
                        FrameLayout fl = (FrameLayout) item;
                        if (fl.getChildCount() > 1) {

...
/**
 * Shimmer User: romainpiel Date: 10/03/2014 Time: 17:06
 */
public class ShimmerViewHelper {
    ...
    private void resetLinearGradient() {
        ...
        // our gradient is a simple linear gradient from textColor to
        // reflectionColor. its axis is at the center
        // when it's outside of the view, the outer color (textColor) will be
        // repeated (Shader.TileMode.CLAMP)
        // initially, the linear gradient is positioned on the left side of the
        // view
    ...
    /**
     * content of the wrapping view's onDraw(Canvas) MUST BE CALLED BEFORE SUPER
     * STATEMENT
     */
    public void onDraw() {

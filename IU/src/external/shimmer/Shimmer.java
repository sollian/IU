...
public class Shimmer {
    ...
    private static final int ANIMATION_DIRECTION_LTR = 0;
    private static final int ANIMATION_DIRECTION_RTL = 1;
    ...
    public Shimmer setAnimatorListener(
    ...
    public <V extends View & ShimmerViewBase> void start(final V shimmerView) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                animator = ObjectAnimator.ofFloat(shimmerView, "gradientX",
                        fromX, toX);
        ...
        if (!shimmerView.isSetUp()) {
            shimmerView
                    .setAnimationSetupCallback(new ShimmerViewHelper.AnimationSetupCallback() {
                        @Override
